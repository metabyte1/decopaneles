...
<html>
  <head>
    <meta charset="UTF-8">
    <title>DecoPaneles | Inventario</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>DecoPaneles</b>Inventario</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                      <a href="http://facebook.com/" target="_blank" class="">Ir a Facebook</a>
                      <a href="" target="_blank" class="">Reservado</a>
                  </li>
